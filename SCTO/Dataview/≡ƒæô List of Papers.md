...
```dataview
TABLE without id file.link as Paper, ShortSummary as Summary, Rating FROM "1∩╕ÅΓâú Primary Sources" sort Rating DESC
```
...
```dataview
TABLE without id file.link as Paper, ShortSummary as Summary, Rating FROM #reviewpaper AND "1∩╕ÅΓâú Primary Sources"  sort Rating DESC
```
...
```dataview
TABLE without id file.link as Paper, ShortSummary as Summary, Rating FROM #Machine_learning  AND "1∩╕ÅΓâú Primary Sources"  sort Rating DESC
```
...
```dataview
TABLE without id file.link as Paper, Title, Rating, DOI FROM #Machine_learning  AND "1∩╕ÅΓâú Primary Sources"  sort Rating DESC
```
